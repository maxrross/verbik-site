...
const SITE_UI_COPY: Record<SiteLocale, SiteUiCopy> = {
    en: {
        ...
        downloadCta: {
            ...
            subtitle: "Search more than 150,000 entries across six languages. No account required.",
...
export const apps: AppConfig[] = [
    {
        ...
        description:
            "Verbik is an offline verb dictionary for iPhone. Search more than 150,000 sourced Russian, Spanish, Italian, French, European Portuguese, and Hebrew entries by the form you actually see, understand the match, and open complete grammar tables.",
        accentColor: "#5A00F5",
        ...
        features: [
            ...
            },
            {
                ...
                body: "More than 150,000 Russian, Spanish, Italian, French, European Portuguese, and Hebrew entries live together in one focused reference app.",
            },
            {
                icon: "textformat.abc",
